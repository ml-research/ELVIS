...
# tasks.update(create_tasks_v3(separate_big_triangle, [
#     "shape",
#     "color",
#     "size",
#     "count"
# ], range(1, 4), size_list, pin))

tasks.update(create_tasks_v3(separate_big_square, props, range(1, 3), size_list, pin))
