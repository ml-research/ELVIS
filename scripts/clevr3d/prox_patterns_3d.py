"""
Proximity pattern task registration for 3D CLEVR.
Mirrors scripts/proximity/prox_patterns.py.
"""
...
def get_patterns(lite=False):
    ...
    pin = False  # principle_in_negative

    all_tasks = []
    all_names = []

    tasks, names = create_tasks_v3(
        non_overlap_fixed_props_3d, feature_props, grp_num_range, size_list, pin
    )
